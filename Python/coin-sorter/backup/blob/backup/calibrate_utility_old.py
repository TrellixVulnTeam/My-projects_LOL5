...
def file_Checker():
	calibrate_color_codes_file="color_code_calibrate.csv"
	edge_points_file = "edge_Points.csv"
	calibrate_color_codes_tmp_file = "color_codes.csv"
	edge_points_tmp_file = "edge_Points_for_detect.csv"
	## if file exists, delete it ##
	if os.path.isfile(calibrate_color_codes_file):
	       os.remove(calibrate_color_codes_file)
	else:    ## Show an error ##
	       print("Error: %s file not found" % calibrate_color_codes_file)
	if os.path.isfile(edge_points_file):
	       os.remove(edge_points_file)
	else:    ## Show an error ##
	       print("Error: %s file not found" % edge_points_file)
	if os.path.isfile(calibrate_color_codes_tmp_file):
	       os.remove(calibrate_color_codes_tmp_file)
	else:    ## Show an error ##
	       print("Error: %s file not found" % calibrate_color_codes_tmp_file)
	if os.path.isfile(edge_points_tmp_file):
	       os.remove(edge_points_tmp_file)
	else:    ## Show an error ##
	       print("Error: %s file not found" % edge_points_tmp_file)
