...
def Coinfinder(img):
   ...
   for keyPoint in keypoints:
      ...
      ## print)
      ## print"X:"+str(X)+"  Y:"+ str(Y)+"  coin:"+str(coin))
      ## print)

      if(Arm_Flag and armOn):
         ## print"sending cordinates and coin to arm controller -- coin:"+ str(coin) +"--X :"+str(X)+"--Y :"+str(Y))
...
def utility_capture():
   ...
   cap.release()
   cv2.destroyAllWindows()
   # ## print"Initializing a camera and capure a single frame for utility")
...
def utility():
   ...
   utility_capture()
   ## print"edge points and RGB values for 10 cent")
   ## printedge_Points_df)
   ## printcolor_code_df)
   ...
   if(k == "y"):
      ...
      main()
   if(k == "n"):
      ## print"Re running utility function")
      utility()
