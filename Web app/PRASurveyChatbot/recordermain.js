...
/*
 * TODO: - offer mono option - "Monitor input" switch
 */
...
function doneEncoding(blob) {
	Recorder.setupDownload(blob, "myRecording" + ((recIndex < 10) ? "0" : "")
			+ recIndex + ".wav");

	currentAudioFileName = currentUserId + "_" + $.now();
	...
	var objKey = "audio/" + currentAudioFileName + ".wav";
	var params = {
		Key : objKey,
		Bucket : bucketName,
